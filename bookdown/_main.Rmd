...
<!--chapter:end:11-introduction.Rmd-->
...
<!--chapter:end:21-x13-overview.Rmd-->
...
<!--chapter:end:32-trading-days.Rmd-->
...
<!--chapter:end:34-seasonal-breaks.Rmd-->
...
<!--chapter:end:41-presence-of-seasonality.Rmd-->
...
<!--chapter:end:51-quality-measures.Rmd-->
