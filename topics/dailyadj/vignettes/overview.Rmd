...
One solution would be to disaggregate, perform daily seasonal adjustment and aggregate again. Here is an example:


```{r ts_frequency_week, include = FALSE, cache = TRUE}
...
ts_frequency_week(casualties_daily, sum) %ts-% casualties_weekly
