...
dums <-
  ...
  select(-wday_Mon, -wday_Sat, -wday_Sun, -month_Jan)
...
We see that, on average, transcations are lower on tuesday and thursay and peak on wednesday. We also see that, on average, transactions are higher in the first half of the year.
