...
- Aggregation tests: How do the aggregated series compare to X-13 adjustments? there is a literature on this (montly GDP vs quarterly). If a monthly adjustment seems good but produces a bad quarterly adjustemnt, it is probably not a good adjustment.

- `qs()`

- compare compontents to X-13
