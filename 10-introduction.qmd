...
This book will teach you how to use X13 in R through the *seasonal* package, which offers access to all features of X13 with a usually much simpler syntax.
