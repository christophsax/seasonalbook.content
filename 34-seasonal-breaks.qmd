...
In many structural breaks, restricting `series.modelspan` may be the easiest way to deal with such series. Resticting the model span, uses only part of the series for model estimation, but applies seasonal adjustment to the whole series:
