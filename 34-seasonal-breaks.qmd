...
It is more straightforward to spot in the monthplot of the series:
...
We don't know anything about the series, but we can speculate that prior to 2000, custom receipts were counted when they were handed in (at the end of the year), rather than at the date of import.
...
Restricting the model span, uses only part of the series for model estimation, but applies seasonal adjustment to the whole series:
