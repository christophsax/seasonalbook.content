...
Controversy?
IMF Handbook says the opposite?
...
This reads as there is a 0 probability that the null-hypothesis of seasonality in the original series can be rejected.
...
A QS value of 0 has a p-value of 1, meaning the Nul-Hypothesis of seasonality in the orgininal value can be savely rejected.
