...
Sometimes, you want to rely on a user defined specification of trading days, a topic covered in section ....
Finally, in section, ... we link the two sections by replicating the built-in regressors in R.
...
In section, ..., we replicate the built-in regressors.
