...
1.  Why it is worth constructing trading days regressors over holiday ones?
1.  Run `seas()` to on AirPassengers using `td1coef` and `td` regressors and compare the results.
1. Consult X-13ARIMA-SEATS Reference Manual. What other options are available as built-in regressors?
