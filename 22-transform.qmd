...
We can think of prior modification factors of events or corrections made to your data that are fixed throughout the adjustment process.
...
X-13A-S has a built in statistical test to decide between log and no transformation.
...
Other restrictions on the allowed transformations exist and can be found in CITE but these situations are rare.
...
MAYBE THIS ISN'T NEEDED BUT SHOULD IT GO SOMEWHERE?
