...
Tranformations, especially lograitmic transformations, are ubiquitous and central to many seasonal adjustment models.
...
For example, if we want to access teh AICc values that were used to determine the appropriatness of the logaritmic model, we use:
