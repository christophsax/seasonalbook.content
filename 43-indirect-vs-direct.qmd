...
Intuitively, indirect adjustment is generally better when the components have - Distinct seasonal patterns - Adjustments of good quality

Direct generally is generally better when the components have - Similar seasonal patterns (summing the series may cancel some noise)
...
https://github.com/jlivsey/CR-SAclass/blob/master/slides/\_11SeasAdjDiags.pdf
...
According to the IMF Manual, Allocating discrepancies on components to achieve consistency should be avoided.
