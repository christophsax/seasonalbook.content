...
1.  Can you explain the difference between an extreme value and an outlier? Does it makes to remove extreme values? What about outliers? Does the same apply for transformation?
