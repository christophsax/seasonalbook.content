...
It is developed from the work of @cleveland76, @hillmer82, @maravall86. If applied properly, SEATS seasonal factors are usually more stable than X-11, and the seasonally adjusted series show less revisions than X11 (??) (see final section for a more extensive discussion).

Like X-11, SEATS applies a series of filters to an observed time series, as described in @sec-seasonal-decomposition. Like X-11, SEATS uses a forecast extended series, in order to obtain unbiased results at the margin.
