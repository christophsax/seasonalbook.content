...
1. How often is your data revised?
1. Does your agency have a policy to freeze data/seasonal adjustment revisions after a fixed period of time?
1. How much time can be devoted to development of initial spec files?
1. How much time can be devoted to maintenance of spec files?
1. What is your maintenance schedule? (yearly, monthly, etc)
1. What are the consequences of a poor adjustment?
1. What are the consequences of large revisions?
1. Will your agency be publishing original series, just SA, trends, seasonal factors?
1. Is there an emphasis on deep methodological understanding of the procedures?
1. Is there an emphasis on training users of released data to have a methodological understanding of the SA process?
