...
Let's apply the previous discuss by hand, using basic R functions.
...
**DISCUSS**, but isn't the idea of estimating the seasonal component more something like this?
Where we average among same periods?
...
The most obvious one is the insufficient length of the adjusted series that is caused by the symmetric filters.
A simple trick to circumvent the problem is to forecast the series - and this is exactly what X13-ARIMA-SEATS does.
