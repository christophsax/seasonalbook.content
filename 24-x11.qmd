...
<!-- FIXME: can we introduce the following bullets? -->
...
<!-- FIXME: complete "Being able to understand the ... " -->
...
<!-- TODO: add reference to `monthplot()` explanation in chp "transform" -->
<!-- TODO: the explanation of SI-ratio is found afterwards which. Move it upper as a note? -->
...
<!-- TODO: point to revisions chapter? -->
...
1.  Use *seasonal* to perform an automated seasonal adjustment of `fdeaths`, using X-11.
