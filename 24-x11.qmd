...
As mentioned above, X-11 is sensitive to outliers, and applies its own extreme value adjustment (see Box for the differences between outliers and extreme values).
