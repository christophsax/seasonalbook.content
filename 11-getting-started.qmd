...
But the adjusted series is not entirely smooth, too, because it still contains the irregular component.
...
X13 is built on top of twenty specs that perform various subtasks of seasonal adjustment.
...
:   When comparing seasonal adjustment models, the stability of the model and the series is often an important consideration.
    ...
    X13 offers tools to analyze revisions.
